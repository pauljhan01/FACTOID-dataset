...
if load_best_model:
    ...
    for i in range(2,8):
        ...
        graphsage_model = GraphSageClassification(in_channels=in_channel, hidden_channels=hidden_channel, out_channels=out_channel,nclass=2, num_layers=i)
        ...
        gat_model = GatV2Classification(in_channels=in_channel, hidden_channels=hidden_channel, out_channels=out_channel,nclass=2, num_layers=i)
    ...
    plt.ylabel("F1 Score")
    plt.legend()
    plt.savefig(os.path.expanduser("../results/plots/f1_score.png"))
    ...
    for i in range(8):
    #i = 4    
        gat_models.append(GatV2Classification(in_channels=in_channel, hidden_channels=hidden_channel, out_channels=out_channel,nclass=2, num_layers=i).to(DEVICE))
        graphsage_models.append(GraphSageClassification(in_channels=in_channel, hidden_channels=hidden_channel, out_channels=out_channel,nclass=2, num_layers=i).to(DEVICE))
